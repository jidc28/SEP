                            ...
                            <div id="welcome">
                                <table border="0">
                                    <tbody>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="Carrera" property="errorCodigo" filter="false"/>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="Carrera" property="errorCodigoFormato" filter="false"/>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="Carrera" property="errorNombre" filter="false"/>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="Carrera" property="errorNombreFormato" filter="false"/>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>Codigo:</td>
