<%-- 
    Document   : EditarNombreDecanatoFail
        ...
        <div id="contenedor">
            ...
            <div id="cuerpo-principal">
                ...
                <div id="contenido-der">
                    <h1 style="background-color: cornflowerblue;width: 200px;margin-left: auto; margin-right: auto">Cambiar Nombre de Decanato</h1>
                    <div id="content">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h1 style="width: 150px;margin-left: auto; margin-right: auto;color: darkblue">Nombre de Decanato</h1>	
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <html:form  action="/cambiarNombreDecanatoA">
