<%-- 
    Document   : ConsultaDecanatoNameSuccess
...
<%
    ...
    ArrayList<Decanato> users = (ArrayList<Decanato>) session.getAttribute("decanatos");
    if (usbid != "") {%>
            ...
            <div id="cuerpo-principal">
                    ...
                    <p align ="center" style="background-color: springgreen;
                       width: 300px; margin-left: auto; margin-right: auto">
                        Nombre de Decanato modificado exitosamente.
                    </p>
