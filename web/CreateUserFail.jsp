                            ...
                            <div id="welcome">
                                <table border="0">
                                    <tbody>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="CreateUserForm" property="errorUsbid" filter="false"/>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="CreateUserForm" property="errorUsbidFormato" filter="false"/>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="CreateUserForm" property="errorContrasena" filter="false"/>
                                                &nbsp;</td></tr>
                                        <tr>
                                        <tr>
                                            <td colspan="2">
                                                <bean:write name="CreateUserForm" property="errorDifierePass" filter="false"/>
                                                &nbsp;</td></tr>
                                        <tr>
