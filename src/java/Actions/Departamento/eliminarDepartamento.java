...
public class eliminarDepartamento extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        /* PARTE DE MANEJO DE ERRORES, OMITIR EN ESTE MOMENTO */
        
        boolean eliminado = DBMS.getInstance().eliminarDepartamento(u);
        ...
        if (!eliminado) {
            ...
            if(tipousuario.equals("administrador")){
                Decanato d = (Decanato) session.getAttribute("decanato");
